...
public class FilenameLoader
{
    ...
    public FilenameLoader()
    {
        fileNameDictionary = new Dictionary<string, string> {
            ...
            { "메스", "ExampleEvidence" },
            { "송곳", "ExampleEvidence" },
            { "원형 전기톱", "ExampleEvidence" },
            { "양날칼", "ExampleEvidence" },
            { "주사기", "ExampleEvidence" },
            { "포르말린", "ExampleEvidence" },
            { "낫", "ExampleEvidence" },
            { "와이어", "ExampleEvidence" },
            { "목장갑", "ExampleEvidence" },
            { "술병", "ExampleEvidence" },
            ...
            { "선물 받은 안경집", "ExampleEvidence" },
            { "미발표 논문", "ExampleEvidence" },
            { "간호일지 수첩", "ExampleEvidence" },
            { "연구비로 결제한 영수증", "ExampleEvidence" },
            { "낡은 고무장갑", "ExampleEvidence" },
            { "눌러 쓴 손편지", "ExampleEvidence" },
        ...
        flavorTextDictionary = new Dictionary<string, string> {
            ...
            { "원형 전기톱", "주로 석고 깁스를 자르는 용도로 사용하는 전기톱입니다. 대부분의 경우 매우 안전하지만, 악의를 지닌 사람의 손에 들렸을 때에는 그렇지 않습니다." },
