...
public class FilenameLoader
{
    ...
    public FilenameLoader()
    {
        ...
        flavorTextDictionary = new Dictionary<string, string> {
            { "지문#1", "사이코메트리로 최대한 정밀하게 검출해낸 지문 기억입니다." },
            { "지문#2", "사이코메트리로 최대한 정밀하게 검출해낸 지문 기억입니다." },
            { "지문#3", "사이코메트리로 최대한 정밀하게 검출해낸 지문 기억입니다." },
            { "지문#4", "사이코메트리로 최대한 정밀하게 검출해낸 지문 기억입니다." },
            ...
            { "부서진 음반", "억지로 힘을 주어 망가뜨린 피해자의 신규 음반입니다. 용의자 (SuspectName)의 피해자를 향한 집요한 분노와 시기심, 질투심이 엿보입니다." },
            { "구겨진 악보", "발표되지 않은 용의자 (SuspectName)의 신곡 악보입니다. 피해자의 신곡과 유사한 코드가 발견됩니다. 피해자의 신곡이 용의자가 작곡하던 곡을 몰래 표절했다고 생각할 수도 있어 보입니다." },
            { "반쯤 빈 향수병", "구매한 지 얼마 되지 않은 향수병입니다. 용의자 (SuspectName)의 개인 물품이지만 피해자가 자신의 것처럼 사용해 벌써 반이 비어있습니다." },
            { "다시 포장한 선물상자", "팬심에 사비를 들여 용의자 (SuspectName)이(가) 피해자에게 선물한 물건입니다. 피해자가 다른 누군가에게 주기 위해 포장을 다시 한 흔적이 보입니다." },
            { "콧소리가 녹음된 MP3", "용의자 (SuspectName)의 콧소리가 녹음된 피해자의 MP3입니다. 추후 이 소리를 이용해 음악을 작곡하겠다는 장난기 서린 대화도 녹음되어 있습니다. 피해자와 용의자가 얼마나 친밀한 관계였는지 짐작하게 합니다." },
            { "선물 받은 안경집", "병원 펠로우가 피해자를 아끼는 의미로 선물한 물건으로, 평소 용의자 (SuspectName)이(가) 존경하던 교수의 신임을 피해자가 가져갔다는 증거입니다." },
            { "미발표한 논문", "피해자와 용의자 (SuspectName)이(가) 공동 발표할 예정이었던 논문입니다. 피해자의 사망 소식이 들린 지 얼마 되지 않았는데 기다렸다는 듯이 피해자의 이름에 취소선이 그어져 있습니다." },
            { "간호일지 수첩", "용의자 (SuspectName)가 들고 다니던 수첩입니다. 피해자가 부당하게 자신을 무시한다고 있다는 메모와 비방이 몇 페이지에 걸쳐 나타납니다." },
            { "연구비로 결제한 영수증", "용의자 (SuspectName)이(가) 연구실 공금으로 사생활 용품을 결제했다는 증거입니다. 피해자가 이 자료를 모으고 있던 것으로 보아 용의자의 공금 횡령을 폭로할 작정이었던 것으로 보입니다." },
            { "낡은 고무장갑", "용의자 (SuspectName)이(가) 시체 처리를 할 때 썼던 고무 장갑입니다. 규정대로 사체를 처리한다면 사용하지 말아야 할 물건입니다. 피해자가 잘못된 시체 처리에 많은 컴플레인을 넣었다는 증언이 있었습니다." },
            { "눌러 쓴 손편지", "평소 고마웠던 주변인을 위해, 피해자가 직접 꾹꾹 눌러 쓴 손편지입니다. 피해자와 용의자 (SuspectName)이(가) 얼마나 친밀한 관계였는지 짐작하게 합니다." },
            { "경구 투여 항불안제", "용의자 (SuspectName)이(가) 고등학생 때부터 지속적으로 복용하던 약물입니다. 이와 관련하여 피해자가 고등학교 때 용의자를 심하게 괴롭혔다는 증언이 있었습니다." },
            { "수상한 커플 반지", "용의자 (SuspectName)와(과) 용의자의 남편이 아닌 다른 이름이 새겨진 커플 반지입니다. 용의자의 불륜 사실을 암시합니다. 피해자가 이를 알았다면 분명 이를 빌미로 피해자를 협박했을 것입니다." },
            { "파산한 법인 통장", "피해자와 용의자 (SuspectName)이(가) 함께 경영하던 사업체 명의의 통장입니다. 피해자가 거금을 인출한 기록과 이로 인해 사업체가 파산한 정황을 확인할 수 있습니다." },
            { "공증 없는 차용증", "법적 효력이 없는 차용증입니다. 용의자 (SuspectName)이(가) 피해자에게 돈을 빌려주었으나 피해자가 갚지 않았다는 정황을 암시합니다." },
            { "자산 관리 위탁 계약서", "용의자 (SuspectName)이(가) 최근 \'자산관리사\'로 취직한 피해자에게 자산 관리 업무를 위탁한다는 내용의 서류입니다. 이런 계약을 체결할 정도면 상호 간의 신뢰가 두터웠던 것으로 보입니다." },
            { "채무조회 서류", "용의자 (SuspectName)이 신부인 피해자의 채무를 조회, 인쇄한 서류입니다. 홀로는 감당하기 힘드나 둘이라면 감당할 수 있는 빚이 있습니다." },
            { "오래된 일기장", "용의자 (SuspectName)이(가) 오래 전부터 적어오던 일기장입니다. 임자 있는 남자를 좋아하게 되었다는 한탄과 남자의 연인을 향한 비방을 꽤 오래 전 기록에서도 확인할 수 있습니다." },
            { "저주 부적", "부부 간의 사랑을 없애주는 저주가 서린 부적입니다. 평소 미신을 신봉하던 용의자 (SuspectName)이(가) 이 결혼을 탐탁치 않게 여기고 있었음을 방증합니다." },
            { "오래된 커플 반지", "용의자 (SuspectName)이(가) 피해자의 남편과 교제할 당시 마련했던 커플 반지입니다. 이걸 지금까지 간직하고 있었다는 것은 용의자의 미련이 많이 남아있음을 암시합니다." },
            { "축가용 마이크", "결혼식을 축복하기 위해 축가를 부르기로 한 용의자 (SuspectName)이(가) 받은 마이크입니다. 시간을 내 축가를 준비할 정도였다면 분명 피해자와의 관계가 친밀했을 것입니다." },
